...
<body class="bg-white font-serif">
    ...
    <header class="flex flex-wrap items-center justify-between px-12 h-32 -mb-32 relative">
        ...
        <div class="w-full md:w-auto flex justify-center">
            <a href="#" class="block text-center text-black text-lg no-underline">
                <img src={url('images/logo.png')} alt={props?.appName} class="w-10 h-auto">
            </a>
        </div>
        ...
        <ul class="flex-1 flex justify-center md:justify-end list-reset">
            <li class="ml-8 hidden md:inline">
                <a href="#"
                    class="text-sm font-bold px-4 py-3 no-underline text-white bg-black hover:bg-gray-800">Subscribe
                    now</a>
            </li>
        </ul>
    ...
    <div class="w-full flex flex-wrap md:h-screen pt-32">
        <div class="pt-6 md:pt-0 w-full md:flex-1 md:order-last">
            <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1400"
        ...
        <div class="w-full p-6 pb-12 md:p-12 md:w-5/12 flex justify-center items-center relative">
            <div class="w-full relative text-center py-12 px-12 md:p-0 md:text-right">
                ...
                <p class="leading-loose tracking-wide text-gray-700">Curabitur convallis aliquet dignissim. Nulla at
                    risus feugiat, egestas lacus at, pharetra risus. Aliquam vitae semper leo, quis ornare massa. Aenean
                    dignissim facilisis imperdiet.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full -mt-6 pt-32 pb-24 px-12 text-center bg-black text-white">
        ...
        <form action="" method="POST">
            ...
            <button
                class="mx-auto bg-white text-black px-6 py-3 flex items-center justify-center text-sm hover:bg-gray-400">Subscribe</button>
    ...
    <div class="py-24 px-12">
        ...
        <div class="container mx-auto flex flex-wrap">
            <div class="w-full md:w-1/2 md:pr-4 flex flex-wrap mb-12 md:mb-0">
                <div class="p-2 w-1/2">
                    <img src="https://images.unsplash.com/photo-1523268755815-fe7c372a0349?w=800"
                        class="w-full h-64 object-cover">
                </div>
                <div class="p-2 w-1/2">
                    <img src="https://images.unsplash.com/photo-1491336477066-31156b5e4f35?w=800"
                        class="w-full h-64 object-cover">
                </div>
                <div class="p-2 w-full">
                    <img src="https://images.unsplash.com/photo-1497382706140-605ee76b3b55?w=800"
                        class="w-full h-64 object-cover">
                </div>
            </div>
            <div class="w-full md:w-1/2 md:pl-4">
                ...
                <div class="max-w-lg">
                    <p class="mb-6 text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis
                        vulputate tellus. Etiam vel placerat lorem, eget ornare nibh. Ut in commodo magna. Quisque vitae
                        fermentum quam. Mauris venenatis id enim at porta. Etiam molestie lorem non odio hendrerit.</p>
                    <p class="mb-6 text-gray-700">At vulputate ligula consequat. Morbi sollicitudin mollis erat, in
                        tempus nisi. Quisque vehicula vitae sem in ornare. Vivamus id odio ligula.</p>
                    <p class="mb-10 text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis
                        vulputate tellus. Etiam vel placerat lorem, eget ornare nibh. Ut in commodo magna. Quisque vitae
                        fermentum quam. Mauris venenatis id enim at porta. Etiam molestie lorem non odio hendrerit.</p>
                    <a href="#" class="inline-block bg-black text-white px-6 py-3 text-sm hover:bg-gray-800">Find out
                        more</a>
